...
const Beams = ({
    ...
    beamHeight = 15,
    beamNumber = 12,
    lightColor = '#00f0ff', // Adjusted for ClickfieldAI brand color
    speed = 2,
    noiseIntensity = 1.75,
    scale = 0.2,
    rotation = 0
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`
                ...
                material: { fog: true },
                uniforms: {
                    diffuse: new THREE.Color(...hexToNormalizedRGB('#0055ff')), // Adding brand blue
    ...
    return (
        <CanvasWrapper>
            ...
            {/* Set transparent background for Canvas to work as an overlay */}
